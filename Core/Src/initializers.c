...
// inicializa prioridade dos ISRs para permitir chamada da API do RTOS de dentro dos ISRs mantendo a
// prioridade maxima de ISRs
...
// inicializar a CAN, chamada na main.c. Existe outra funcao que inicializa o periferico da CAN na
// main.c
void init_CAN() {
