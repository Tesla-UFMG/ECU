...
typedef struct // struct de modo
{
    ...
    bool freio_regen; // frenagem regenerativa (1 para ativada, 0 para
                      // desativada)
    ...
    bool bat_safe;         // reducao de consumo de bateria se em niveis criticos (1
                           // ativo, 0 desat)
    int torq_gain;         // ganho de torque, aconselhavel q seja proporcional ao
                           // torque maximo ( de 0 a 40)
...
#define ALL_ERRORS_FLAG                                                                            \
    (APPS_ERROR_FLAG | BSE_ERROR_FLAG | INVERTER_COMM_ERROR_FLAG | SU_F_ERROR_FLAG |               \
