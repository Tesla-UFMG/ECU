...
void odometer_calc() {
    ...
    for (;;) {
        ...
        //
        //        if (speed_var.wheels[FRONT_RIGHT] != 0 && speed_var.wheels[FRONT_LEFT]
        //        != 0) {
        ...
        //        }
        //
        //        const uint16_t instant_distant_traveled =
        //        calculate_distance(odometer_speed_data); partial_dist_traveled +=
        //        instant_distant_traveled; total_dist_traveled +=
        //        instant_distant_traveled;
        //        osMessageQueuePutOverwrite(q_odometer_calc_save_messageHandle,
        //                                   &total_dist_traveled, 0);
