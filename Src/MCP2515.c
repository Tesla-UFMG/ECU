...
/* Pin needs to be adjusted according to the setting. Modify below items for your SPI configurations*/
extern SPI_HandleTypeDef        hspi2;
#define SPI_CAN                 &hspi2
#define SPI_TIMEOUT             10
#define MCP2515_CS_HIGH()   HAL_GPIO_WritePin(CS_CAN_GPIO_Port, CS_CAN_Pin, GPIO_PIN_SET)
#define MCP2515_CS_LOW()    HAL_GPIO_WritePin(CS_CAN_GPIO_Port, CS_CAN_Pin, GPIO_PIN_RESET)
...
/* Switching the MCP2515 to Setup Mode */
...
/* Switch the MCP2515 to Normal mode*/
...
/* Switch the MCP2515 to Sleep mode*/
