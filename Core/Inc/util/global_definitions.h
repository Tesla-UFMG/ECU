...
#define CROSS_VALIDATION_ERROR_THREAD_FLAG	  			(1 << 9)
...
#define DYNAMIC_CONTROL_WARN_FLAG (1 << 13)
#define FLASH_SAVE_LIMIT_FLAG     (1 << 14)
// Soft error flags (RTD keeps on, torque ref to inverter is set to 0)

#define BSE_ERROR_FLAG  (1 << 18) // Regulamento: EV.5.7 (2021)
#define APPS_ERROR_FLAG (1 << 19) // Regulamento: T.4.2 (2021)

// Hard error flags (RTD disable)
#define INVERTER_CAN_TRANSMIT_ERROR_FLAG (1 << 21)
#define SU_F_ERROR_FLAG                  (1 << 22)
#define INVERTER_BUS_OFF_ERROR_FLAG      (1 << 23)
#define LEFT_INVERTER_COMM_ERROR_FLAG    (1 << 24)
#define RIGHT_INVERTER_COMM_ERROR_FLAG   (1 << 25)
