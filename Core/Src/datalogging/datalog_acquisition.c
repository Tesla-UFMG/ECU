...
void datalog_acquisition(){
	...
	for(;;){
		...
		// divisao da flag de 32 bits em duas mensagens de 16bits, para isso o valor da flag eh
		// passado e shiftado para a direita 16x, apos ser shiftado o que permaneceu nos 16 bits
		// mais significativos eh ignorado a partir da operacao and
