...
void steering_read(void* argument) {
    ...
    for (;;) {
        ...
        // Se o minimo do volante for menor que 0, o sensor voltara no valor
        // maximo do ADC se isso acontecer, o valor do ADC voltara para 4095
        // entao subtrai 4095 do valor lido, dando um valor negativo que pode
        // ser aplicado na formula o mesmo vale pro zero do volante
        ...
        // SPAN_ALINHAMENTO eh apenas um span pra ainda considerar o volante no
        // centro ate uma certa quantidade
