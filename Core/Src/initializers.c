...
// inicializa prioridade dos ISRs para permitir chamada da API do RTOS de dentro
// dos ISRs mantendo a prioridade maxima de ISRs
void init_NVIC_priorities() {
    ...
    // TODO(renanmoreira): averiguar a prioridade correta para botoes de modo e
    // RTD
...
// inicializar a CAN, chamada na main.c. Existe outra funcao que inicializa o
// periferico da CAN na main.c
void init_CAN() {
