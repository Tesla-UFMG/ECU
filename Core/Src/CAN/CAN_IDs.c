...
void initialize_CAN_IDs() {
    CAN_ID_map[ID_SPEED_AVG]            = (CAN_ID_t)INTERNAL_ID_SPEED_AVG;
    ...
    // CAN_ID_map[ID_RED_TORQUE_ROD_ESQ] = (CAN_ID_t)INTERNAL_ID_RED_TORQUE_ROD_ESQ;
    // CAN_ID_map[ID_RED_TORQUE_ROD_DIR] = (CAN_ID_t)INTERNAL_ID_RED_TORQUE_ROD_DIR;
    // CAN_ID_map[ID_EXTRA_CONTROL_DIN]          =
    // (CAN_ID_t)INTERNAL_ID_EXTRA_CONTROL_DIN; CAN_ID_map[ID_EXTRA_CONTROL_DIN]      =
    // (CAN_ID_t)INTERNAL_ID_EXTRA_CONTROL_DIN;
    CAN_ID_map[ID_REGEN_BRAKE_STATE] = (CAN_ID_t)INTERNAL_ID_REGEN_BRAKE_STATE;
    CAN_ID_map[ID_IMU_BSE_ERROR]     = (CAN_ID_t)INTERNAL_ID_IMU_BSE_ERROR;
    CAN_ID_map[ID_STATUS_DATALOG]    = (CAN_ID_t)INTERNAL_ID_STATUS_DATALOG;
    CAN_ID_map[ID_IMU_SPEED_ERROR]   = (CAN_ID_t)INTERNAL_ID_IMU_SPEED_ERROR;
    ...
    // CAN_ID_map[ID_ACCEL X]        = (CAN_ID_t)INTERNAL_ID_ACCEL_X;
    // CAN_ID_map[ID_ACCEL Y]        = (CAN_ID_t)INTERNAL_ID_ACCEL_Y;
    // CAN_ID_map[ID_ACCEL Z]        = (CAN_ID_t)INTERNAL_ID_ACCEL_Z;
    // CAN_ID_map[ID_TEMP_IMU]        = (CAN_ID_t)INTERNAL_ID_TEMP_IMU;
    // CAN_ID_map[ID_GYRO X]        = (CAN_ID_t)INTERNAL_ID_GYRO_X;
    // CAN_ID_map[ID_GYRO Y]        = (CAN_ID_t)INTERNAL_ID_GYRO_Y;
    // CAN_ID_map[ID_GYRO Z]        = (CAN_ID_t)INTERNAL_ID_GYRO_Z;
    // CAN_ID_map[ID_IMU]        = (CAN_ID_t)INTERNAL_ID_IMU_ERROR;
