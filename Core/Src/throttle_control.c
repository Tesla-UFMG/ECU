...
void throttle_control(void* argument) {
    ...
    for (;;) {
        ...
        osMessageQueueGet(q_throttle_controlHandle, &message, NULL,
                          osWaitForever); // espera por uma mensagem com o valor de APPS

        // verifica a se a flag de RTD esta ativada e se as flags de erro de BSE
        // e APPS estao desativadas, caso sim, atualiza o valor de
        // throttle_percent para o da mensagem, caso nao atualiza para 0
