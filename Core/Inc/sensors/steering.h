...
#define VOLANTE_ALINHADO      2150		   // ADC value when the steering wheel is in neutral position.
#define SPAN_ALINHAMENTO      100           // Sensor Dead zone.
#define VOLANTE_MAX           3440		   // Maximum value that the sensor can achieve once installed.
#define VOLANTE_MIN           730          // Minimum value that the sensor can achieve once installed.
