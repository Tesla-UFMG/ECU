...
void odometer_save() {
    ...
    for (;;) {
        ...
        //        // Wait the flag to be set so the task runs. The flag is set when RTD
        //        state is
        //        // left
        //        osThreadFlagsWait(ODOMETER_SAVE_THREAD_FLAG, osFlagsWaitAny,
        //        osWaitForever); osMessageQueueGet(q_odometer_calc_save_messageHandle,
        //        &total_distance_traveled,
        //                          NULL, osWaitForever);
        //
        //        // Read distance and number of saves in flash
        //        Flash_Read_Data(ODOMETER_DATA_FLASH_ADDR, flash_read_data,
        //        WORDS_READ_TWO); total_distance_traveled =
        //        cm_to_m(total_distance_traveled);
        //        // Check if the distance traveled is enough to save. Fill the data array
        //        and save
