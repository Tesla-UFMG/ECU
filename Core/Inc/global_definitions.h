...
#define SU_F_ERROR_FLAG             1 << 24
#define INVERTER_BUS_OFF_ERROR_FLAG 1 << 25
#define BUS_OFF_ERROR_FLAG          1 << 21
#define INVERTER_COMM_ERROR_FLAG    1 << 26
...
#define ALL_ERRORS_FLAG             APPS_ERROR_FLAG | BSE_ERROR_FLAG | INVERTER_COMM_ERROR_FLAG | SU_F_ERROR_FLAG | INVERTER_BUS_OFF_ERROR_FLAG | BUS_OFF_ERROR_FLAG
